...
_Note: This README is only relevant to the latest version of our plugin. If you are using an older version, please switch to the relevant tag on [our GitHub repo](https://github.com/microsoft/react-native-washington-push) to view the docs for that particular version._
...
| v0.65                   | v7.2+ _(RN updated iPhone-target-version)_             |

_NOTE: `react-native-washington-push` versions lower than **[v5.7.0](https://github.com/microsoft/react-native-washington-push/releases/tag/v5.7.0)** will stop working in the near future. You can find more information in our [documentation](https://github.com/microsoft/code-push/blob/master/migration-notice.md)._
...
```shell
npm install --save react-native-washington-push
```
...
_NOTE: If you are using [Redux](http://redux.js.org) and [Redux Saga](https://redux-saga.js.org/), you can alternatively use the [react-native-washington-push-saga](http://github.com/lostintangent/react-native-washington-push-saga) module, which allows you to customize when `sync` is called in a perhaps simpler/more idiomatic way._
