...
2. In your `android/app/build.gradle` file, add the `:react-native-washington-push` project as a compile-time dependency:

   ```gradle
   ...
   dependencies {
       ...
       compile project(':react-native-washington-push')
   }
   ```
