...
module.exports = () => {
  ...
  var reactNativeVersion =
    package && package.dependencies && package.dependencies["react-native"];
  ...
  if (!reactNativeVersion) {
    ...
    if (~appDelegateContents.indexOf(newJsCodeLocationAssignmentStatement)) {
      ...
      if (jsCodeLocations.length === 1) {
        ...
        var jsCodeLocationPatch = linkTools.getJsCodeLocationPatch(
  ...
  if (parsedInfoPlist.CodePushDeploymentKey) {
    ...
    return inquirer
      ...
      .then(function (answer) {
        parsedInfoPlist.CodePushDeploymentKey =
          answer.iosDeploymentKey || "deployment-key-here";
